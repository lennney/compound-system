...
跨平台的 Compound Engineering System，能在 Hermes、Claude Code、Codex 上运行。核心：任务后自动反思 + 错误提取 + 知识积累。
...
- **跨平台**：Hermes / Claude Code / Codex 各一个适配器
...
# 3. Set up LLM API key (for reflect.sh)
export LLM_API_KEY="your-api-key"

# 4. After a task, run reflection
scripts/compound.sh --task "your task description" --status "success|partial|failed"

# 5. Before a task, search solutions
...
Copy `platforms/hermes/SKILL.md` to `~/.hermes/skills/compound-system/SKILL.md`

### Claude Code

Copy `platforms/claude-code/CLAUDE.md` to your project root

### Codex

Copy `platforms/codex/codex.md` to your project root
